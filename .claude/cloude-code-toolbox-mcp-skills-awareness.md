...
_Generated: 2026-08-10T11:07:24.938Z_
...
Workspace `mcp.json` _(folder: my-gsm-store)_

- **/Users/sazid/DT/my-gsm-store/.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **/Users/sazid/.claude.json** — _File exists — no servers defined_
